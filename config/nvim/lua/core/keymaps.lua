...
M.gitsigns = {
  ...
  { mode = "n", "<leader>gd", "<CMD>Gitsigns diffthis --vertical=true<CR>", desc = "Diff HEAD" },
  { mode = "n", "<leader>gp", "<CMD>Gitsigns preview_hunk<CR>", desc = "Show diff of current hunk" },
  { mode = "n", "<leader>grb", "<CMD>Gitsigns reset_buffer<CR>", desc = "Reset buffer to base" },
  { mode = "n", "<leader>grh", "<CMD>Gitsigns reset_hunk<CR>", desc = "Reset hunk to base" },
